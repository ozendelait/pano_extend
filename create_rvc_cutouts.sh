...
EXT_PANO_SCRIPT_DIR="$(dirname "$(readlink -f "$0")")"
...
pushd ${USE_DATA_ROOT}
python3 ${EXT_PANO_SCRIPT_DIR}/gen_cutouts.py ${COMMON_PARAMS_TRAIN} --input_json ./wd2_pano.rvc_train.json  --input_root ./wilddash/images/
...
python3 ${EXT_PANO_SCRIPT_DIR}/gen_cutouts.py ${COMMON_PARAMS_TRAIN} --input_json ./coco_pano.rvc_train.json --input_root ./coco/images/train2017/
python3 ${EXT_PANO_SCRIPT_DIR}/gen_cutouts.py ${COMMON_PARAMS_VAL} --input_json ./coco_pano.rvc_val.json --input_root ./coco/images/val2017/
popd